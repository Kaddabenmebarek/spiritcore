package com.idorsia.research.spirit.core.util.property;
...
public class PropertyKey implements Serializable {
	...
	private static final long serialVersionUID = -6316778733300401262L;
	...
	public static final PropertyKey MIN_VERSION = new PropertyKey(Tab.INTERNAL, "Minimum Software Version", "", "minimum.version", null);
	...
	public static final PropertyKey SYSTEM_DATEFORMAT = new PropertyKey(Tab.SYSTEM, "DateTime Format", "Localized DateTime format. Be sure to never change it", "format.date", FormatterUtils.DateTimeFormat.SWISS.toString(), MiscUtils.flatten(FormatterUtils.DateTimeFormat.values())) {
		private static final long serialVersionUID = -1349186764278044531L;
	...
	public static final PropertyKey STUDY_STATES = new PropertyKey(Tab.STUDY, "States (CSV)", "configurable workflow states allowed by the study (CSV)", "study.states", "EXAMPLE, TEST, ONGOING, IRBR, PUBLISHED, STOPPED");
	...
	public static final PropertyKey STUDY_METADATA_NAME = new PropertyKey(STUDY_METADATA, "Display Name", "Display for the end user", "name", "") {
		private static final long serialVersionUID = 1810495103260252302L;
	...
	public static final PropertyKey STUDY_METADATA_DATATYPE = new PropertyKey(STUDY_METADATA, "DataType", "", "datatype", "", "ALPHA, AUTO, LIST, DATE") {
		private static final long serialVersionUID = 8756232584200313771L;
	...
	public static final PropertyKey STUDY_METADATA_PARAMETERS = new PropertyKey(STUDY_METADATA, "Parameters", "list of choices if datatype is LIST", "parameters", "") {
		private static final long serialVersionUID = -1658279936482125595L;
	...
	public final static PropertyKey STUDY_STATES_READ = new PropertyKey(STUDY_STATES, "Read roles", "(can query results/biosamples)", "read", "ALL", USER_ROLES) {
		private static final long serialVersionUID = 2364253076352606908L;
		@Override public String getDefaultValue(String nestedValue) {
			SpiritPropertyService spiritPropertyService = (SpiritPropertyService) ContextShare.getContext().getBean("spiritPropertyService");
			return spiritPropertyService.isOpen()?"ALL":
				nestedValue.equalsIgnoreCase("STOPPED")?"NONE": "";
		}
		@Override public String[] getSpecialChoices() {return new String[]{"ALL", "RESTRICTED", "NONE"};}
	};
	...
	public static final PropertyKey STUDY_STATES_WORK = new PropertyKey(STUDY_STATES, "Work Roles", "Roles of study workers (can add samples)", "work", "", USER_ROLES) {
		private static final long serialVersionUID = 5791257417749211539L;
	...
	public static final PropertyKey STUDY_STATES_EDIT = new PropertyKey(STUDY_STATES, "Edit Roles", "Roles of study editors (can edit study design/rights)", "edit", "", USER_ROLES) {
		private static final long serialVersionUID = -7040455703812861459L;
	...
	public static final PropertyKey STUDY_STATES_DELETE = new PropertyKey(STUDY_STATES, "Delete Roles", "Delete study roles", "delete", "", USER_ROLES) {
		private static final long serialVersionUID = -7830016638524906365L;
		@Override public String getDefaultValue(String nestedValue) {return "";};
		@Override public String[] getSpecialChoices() {return new String[]{"ALL", "NONE"};}
	};
	...
	public static final PropertyKey STUDY_FEATURE_LIVEMONITORING = new PropertyKey(Tab.STUDY, "Feature: Live Monitoring", "Allow the live monitoring", "study.feature.monitoring", "true", "true, false");

	public static final PropertyKey STUDY_LIVEMONITORING_DISPLAY_ACTIONS_BEFORE = new PropertyKey(Tab.STUDY, "Live Monitoring: show actions before (days)", "Display actions before current date", "study.feature.monitoring.days_before", "3");
	public static final PropertyKey STUDY_LIVEMONITORING_DISPLAY_ACTIONS_AFTER = new PropertyKey(Tab.STUDY, "Live Monitoring: show actions after (days)", "Display actions after current date", "study.feature.monitoring.days_after", "1");
